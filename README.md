...
- **Description**: This Jupyter notebook is the heart of the project, containing the main logic and algorithms.
...
- **Purpose**: Algorithms and methods for automated searching and data analysis.
...
- **Content**: Paths and results generated by machine learning algorithms or automated processes.

### Supplementary Notebooks

#### `other_notebooks_used` Folder
- **Content**: Additional Jupyter notebooks that provide insights into the developmental process and exploratory analysis.
